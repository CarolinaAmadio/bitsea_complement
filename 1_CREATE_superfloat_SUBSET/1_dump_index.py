...
if args.type=="superfloat":
    VARLIST=['DOXY','NITRATE','CHLA',  'PRES','PSAL','TEMP','PH_IN_SITU_TOTAL', 'BBP700','BBP532', 'DOWNWELLING_PAR','CDOM','DOWN_IRRADIANCE380'       ,'DOWN_IRRADIANCE412'       ,'DOWN_IRRADIANCE490' , 'PSEUDO_CHLA', 'PSEUDO_NITRATE', 'PSEUDO_PHOSPHATE']
